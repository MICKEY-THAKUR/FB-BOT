...
"https://i.imgur.com/jrYsBnF.jpeg"
     ...
     var callback = () => api.sendMessage({body:`┏━━━━━┓\n     वीर-ठाकुर                    ✧═══•❁😛❁•═══✧\n┗━━━━━┛\n\nदेख लो मेरे एडमिन वीर-ठाकुर को सबसे अलग मासूम चेहरा भोली सी सूरत आखों में प्यार दिल में खुमार ♥️`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
