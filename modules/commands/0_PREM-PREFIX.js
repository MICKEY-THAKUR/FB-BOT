...
module.exports.handleEvent = async ({ event, api, Threads }) => {
  ...
  if ((this.config.credits) != "NEHA THAKUR") { return api.sendMessage(`NEHA-THAKUR-BOT-CREATER 🙂`, threadID, messageID)}
  function out(data) {
